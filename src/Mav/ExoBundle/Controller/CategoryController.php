...
use Mav\ExoBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MavExoBundle:Category')->findAll();
     ...
     * @Method("POST")
     * @Template("MavExoBundle:Category:new.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("MavExoBundle:Category:edit.html.twig")
     */
